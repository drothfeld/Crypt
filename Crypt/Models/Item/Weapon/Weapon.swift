...
class Weapon: Item {
    ...
    // Constructor
    init(name: String, description: String, rarity: Rarity, inventorySpace: Int, goldValue: Int, damageType: [DamageType], damageRange: NumberRange?, healRange: NumberRange?, hitChance: Double, statBonus: [Int]) {
