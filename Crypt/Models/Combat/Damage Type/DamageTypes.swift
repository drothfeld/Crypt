...
let fire_damage: DamageType = DamageType(
    name: "Fire",
...
let ice_damage: DamageType = DamageType(
    name: "Ice",
...
let thunder_damage: DamageType = DamageType(
    name: "Thunder",
...
let physical_melee_damage: DamageType = DamageType(
    name: "Physical Melee",
...
let physical_ranged_damage: DamageType = DamageType(
...
let demon_damage: DamageType = DamageType(
    name: "Demon",
...
let holy_damage: DamageType = DamageType(
    name: "Holy",
...
let ethereal_damage: DamageType = DamageType(
    name: "Ethereal",
...
let undead_damage: DamageType = DamageType(
    name: "Undead",
...
let chaos_damage: DamageType = DamageType(
    name: "Chaos",
...
let divine_damage: DamageType = DamageType(
    name: "Divine",
